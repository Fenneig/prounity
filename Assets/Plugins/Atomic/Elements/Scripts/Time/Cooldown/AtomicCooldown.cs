...
{
    public sealed class AtomicCooldown : ICooldown, MainThreadDispatcher.IFlushable
    {
        ...
        public AtomicCooldown(float duration) : this(duration, duration)
        {
        }

        public AtomicCooldown(float duration, float current)
        {
