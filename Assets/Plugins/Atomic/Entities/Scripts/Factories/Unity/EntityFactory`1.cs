...
namespace Atomic.Entities
{
    ...
    public abstract class EntityFactory<TEntity, TArgs> : ScriptableObject, IEntityFactory<TEntity, TArgs>
        where TArgs : IArgs
        where TEntity : IEntity
    {
        ...
        private protected virtual void Compile()
        {
            ...
            try
            {
                ...
                {
                    Debug.LogWarning($"{nameof(EntityFactory<TEntity, TArgs>)}: Create() returned null.",
                        this);
                }
                else
                {
