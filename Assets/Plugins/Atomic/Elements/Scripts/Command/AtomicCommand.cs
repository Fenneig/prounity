...
{
    public sealed class AtomicCommand : ICommand, MainThreadDispatcher.IFlushable
    {
    ...
    public sealed class AtomicCommand<T> : ICommand<T>, MainThreadDispatcher.IFlushable
    {
    ...
    public sealed class AtomicCommand<T1, T2> : ICommand<T1, T2>, MainThreadDispatcher.IFlushable
    {
    ...
    public sealed class AtomicCommand<T1, T2, T3> : ICommand<T1, T2, T3>, MainThreadDispatcher.IFlushable
    {
    ...
    public sealed class AtomicCommand<T1, T2, T3, T4> : ICommand<T1, T2, T3, T4>, MainThreadDispatcher.IFlushable
    {
