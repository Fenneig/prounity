...
namespace Atomic.Entities
{
    public class PrefabEntityPoolTests
    {
        ...
        public IEnumerator Rent_ReturnsEntity_ActivatesIt()
        {
            ...
            var entity = SceneEntity.Cast(_pool.Rent(_prefab));
        ...
        public IEnumerator Rent_WithPositionAndRotation_SetsTransform()
        {
            ...
            var entity = SceneEntity.Cast(_pool.Rent(_prefab, position, rotation));
            yield return null;
        ...
        {
            SceneEntity entity = SceneEntity.Cast(_pool.Rent(_prefab));
            _pool.Return(entity);
            yield return null;
        ...
        public IEnumerator Rent_WithoutInit_CreatesNewPool()
        {
            ...
            Assert.IsNotNull(entity);
            Assert.AreEqual("TestEntity", SceneEntity.Cast(entity).name);
            Assert.IsTrue(_pool.HasPool("TestEntity"));
        }

        public class TestPrefabEntityPool : PrefabEntityPool<IEntity, SceneEntity>
        {
            public Stack<SceneEntity> GetStack(string name)
            {
                var field = typeof(PrefabEntityPool<IEntity, SceneEntity>)
                    .GetField("_pools",
