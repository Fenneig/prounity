...
namespace Atomic.Entities
{
    ...
    /// <typeparam name="TEntity">The type of entity managed by the pools. Must implement <see cref="IEntity"/>.</typeparam>
    public interface IMultiEntityPool<in TKey, TEntity> : IDisposable where TEntity : IEntity
    {
        /// <summary>
