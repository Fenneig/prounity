...
namespace Atomic.Entities
{
    ...
    /// It extends <see cref="EntityBaker{E}"/> with a non-generic implementation for <see cref="IEntity"/>.
    /// 
    ...
    public abstract class EntityBaker<TArgs> : EntityBaker<IEntity, TArgs> where TArgs : IArgs
    {
        // <summary>
        ...
        /// </remarks>
        protected abstract void Install(IEntity entity, TArgs args);
    }
}
#endif