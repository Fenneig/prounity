...
{
    public class AtomicEvent : IEvent, IDisposable, 
    ...
    public class AtomicEvent<T> : IEvent<T>, IDisposable, 
        MainThreadDispatcher.IFlushable
    {
    ...
    public class AtomicEvent<T1, T2> : IEvent<T1, T2>, IDisposable, 
        MainThreadDispatcher.IFlushable
    {
    ...
    public class AtomicEvent<T1, T2, T3> : IEvent<T1, T2, T3>, IDisposable, 
        MainThreadDispatcher.IFlushable
    {
    ...
    public class AtomicEvent<T1, T2, T3, T4> : IEvent<T1, T2, T3, T4>, IDisposable, 
        MainThreadDispatcher.IFlushable
    {
