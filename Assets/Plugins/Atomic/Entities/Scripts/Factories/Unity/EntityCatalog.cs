...
{
    /// <summary>
    /// A concrete Unity <see cref="ScriptableObject"/> implementation of <see cref="EntityCatalog{K,E,F}"/>
    ...
    public abstract class EntityCatalog<TArgs> : EntityCatalog<string, IEntity, EntityFactory<TArgs>, TArgs>,
        ...
        where TArgs : IArgs
    {
        ...
        protected override string GetKey(EntityFactory<TArgs> factory) => factory.Name;
    }
}
#endif