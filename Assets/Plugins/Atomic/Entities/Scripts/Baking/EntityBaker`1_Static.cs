...
{
    public partial class EntityBaker<TEntity, TArgs>
    {
        /// <summary>
        /// Finds all <see cref="EntityBaker{E}"/> components in the scene and bakes them into entities.
        ...
        public static TEntity[] BakeAll(TArgs args, bool includeInactive = true)
        {
            ...
            var bakers = FindObjectsByType<EntityBaker<TEntity, TArgs>>(include, FindObjectsSortMode.None);
        ...
        /// <summary>
        /// Collects entities from all <see cref="EntityBaker{E}"/> components in the scene
        ...
        /// </exception>
        /// <remarks>
        /// This method finds all <see cref="EntityBaker{E}"/> instances in the scene and
        ...
        /// <summary>
        /// Bakes all <see cref="EntityBaker{E}"/>s in a specific <see cref="Scene"/>.
        /// </summary>
        ...
        public static List<TEntity> Bake(TArgs args, Scene scene, bool includeInactive = true)
        {
            ...
            for (int i = 0, rootCount = rootObjects.Length; i < rootCount; i++)
            {
                ...
                var bakers = rootObject.GetComponentsInChildren<EntityBaker<TEntity, TArgs>>(includeInactive);
        ...
        /// <summary>
        /// Bakes all <see cref="EntityBaker{E}"/>s in a specific <see cref="Scene"/> and adds them to the provided collection.
        /// </summary>
        /// <param name="scene">The scene whose root objects should be searched.</param>
        ...
        public static void Bake(TArgs args, Scene scene, ICollection<TEntity> results, bool includeInactive = true)
        {
            ...
            for (int i = 0, objectCount = objects.Length; i < objectCount; i++)
            {
                ...
                var bakers = go.GetComponentsInChildren<EntityBaker<TEntity, TArgs>>(includeInactive);
        ...
        /// <summary>
        /// Bakes all <see cref="EntityBaker{E}"/> components attached to or under the specified GameObject.
        /// </summary>
        ...
        {
            var bakers = gameObject.GetComponentsInChildren<EntityBaker<TEntity, TArgs>>(includeInactive);
            int count = bakers.Length;
            TEntity[] entities = new TEntity[count];
