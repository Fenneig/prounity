...
{
    /// <summary>
    /// An optimized variant of <see cref="EntityBaker{E}"/> that integrates tightly with a corresponding <see cref="EntityView{E}"/>.
    /// </summary>
    ...
    /// <list type="number">
    /// <item>Creates a new entity instance via the assigned <see cref="EntityFactory{E}"/>.</item>
    ...
    public abstract class EntityBakerOptimized<TKey, TEntity, TView, TArgs> : EntityBaker<TEntity, TArgs>
...

    {
        ...
        [Space]
        [SerializeField]
        private EntityFactory<TEntity, TArgs> _factory;
