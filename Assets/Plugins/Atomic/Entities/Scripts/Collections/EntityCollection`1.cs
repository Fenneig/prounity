...
namespace Atomic.Entities
{
    ...
    {
        private static readonly ProfilerMarker s_removeMarker = new($"EntityCollection<{typeof(E).Name}>.Remove");
        private static readonly ProfilerMarker s_addMarker = new($"EntityCollection<{typeof(E).Name}>.Add");
        private static readonly ProfilerMarker s_containsMarker = new($"EntityCollection<{typeof(E).Name}>.Contains");
